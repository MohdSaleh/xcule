...
class TvDatafeed:
    ...
    def __init__(
        self,
        username: str = "tugoftrades",
        password: str = "toc__123#",
    ) -> None:
        ...
        while True:
            ...
            try:
                ...
                for xi in x:
                    ...
                    if lprice != 0:
                        print(row)
                        # print("OPEN:", data[i][2], "HIGH:",data[i][3], "LOW:",data[i][4], "CLOSE:",data[i][5])
                        return row
...
@app.websocket("/ws")
async def websocket_endpoint(websocket: WebSocket, symbol : str, tf: str, ex: str):
    ...
    while True:
        ...
        if prevtf != tf or prevsymbol != symbol:
            break
